...
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 
  (process.env.NODE_ENV === 'production' 
    ...
    : 'http://localhost:5001/api'); // Local development with Express backend
  ...
  register: async (userData) => {
    try {
      ...
      if (error.code === 'ECONNREFUSED' || error.code === 'ERR_NETWORK') {
        errorData = { message: 'Cannot connect to server. Please make sure the Next.js development server is running' };
