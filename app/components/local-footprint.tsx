...
const LocalFootprint = () => {
  return (
    <section className="section-spaced relative scroll-mt-28 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#FF4500]">Coverage</p>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-3">
          {footprintItems.map((item) => (
            <a
              ...
              className="group cursor-pointer rounded-3xl border border-white/10 bg-[#15181b] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] transition-all duration-300 hover:-translate-y-1 hover:border-[#FF4500]/60 hover:shadow-[0_18px_34px_rgba(20,184,166,0.12)]"
            >
              <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#FF4500] text-black shadow-[0_8px_22px_rgba(249,115,22,0.22)] transition group-hover:scale-110">
        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-stretch">
          <div className="rounded-3xl border border-white/10 bg-[#15181b] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
            <p className="text-sm font-bold uppercase tracking-wide text-[#FF4500]">Active Service Area</p>
            <p className="mt-4 text-base leading-relaxed text-zinc-300">
              Coverage: Riebeek Kasteel, Malmesbury, Gouda, Riebeek West, Hermon, Abbotsdale, Chatsworth and Swartland region
            </p>
            <div className="mt-6 rounded-2xl border border-[#FF4500]/25 bg-[#FF4500]/10 p-4">
          ...
          <div className="relative self-center overflow-hidden rounded-3xl border border-[rgba(255,255,255,0.07)] bg-[rgba(255,255,255,0.02)] shadow-[0_22px_45px_rgba(0,0,0,0.38)]">
            <div className="absolute left-4 right-4 top-4 z-10 rounded-2xl border border-[rgba(255,255,255,0.07)] bg-[rgba(0,0,0,0.5)] px-4 py-3 shadow">
