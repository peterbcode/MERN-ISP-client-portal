...
const LocalFootprint = () => {
  return (
    <section className="texture-dots relative scroll-mt-28 bg-[radial-gradient(circle_at_18%_10%,rgba(20,184,166,0.08),transparent_38%),linear-gradient(to_bottom,#0c0e11,#111315)] py-14 text-white">
