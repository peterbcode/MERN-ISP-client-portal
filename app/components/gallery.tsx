        ...
        <AnimatedSection direction="up" delay={200} className="mx-auto w-full max-w-[1800px] pb-6 lg:pb-12">
          <div className="grid gap-4 md:grid-cols-3">
            {galleryItems.map((item, index) => (
              <article
                key={item.src}
                className={`group relative min-h-[320px] overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950 shadow-[0_18px_32px_rgba(0,0,0,0.35)] ${
              ...
              >
                <img
                  ...
                  alt={item.alt}
                  loading="lazy"
                  className="h-full min-h-[320px] w-full object-cover transition duration-500 group-hover:scale-105 group-hover:brightness-110"
                />
